...
1. Read the skill guide: `skills/bounded-contexts/SKILL.md`
2. Follow the session flow through all 13 phases
3. Load facilitator prompts from `skills/bounded-contexts/references/facilitator-prompts.md` for each phase
4. When facing contested boundaries or overlapping contexts, consult `skills/bounded-contexts/references/common-situations.md`
5. Generate the output artifact using `skills/bounded-contexts/templates/context-map.md`
