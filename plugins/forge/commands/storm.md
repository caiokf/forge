...
1. Read the skill guide: `skills/event-storming/SKILL.md`
2. Follow the session flow through all 10 phases
3. Load facilitator prompts from `skills/event-storming/references/facilitator-prompts.md` for each phase
4. Generate the output artifact using `skills/event-storming/templates/event-storming-board.md`
